...
import { Card, CardBody, CardTitle, Button, CardSubtitle, CardText, Container, Row, Col } from 'reactstrap';
...
const FunctionalComponentDemo = function () {
    return (
        ...
        <hr />
                <center><h1>Arrow Function versus Functional Syntax</h1></center>
            <Row>
            <Col md="6">
            ...
            <Card>
                <img width="100%" height="280px" src="https://i.ytimg.com/vi/BwAakF_VUV8/maxresdefault.jpg" alt="Card cap" />
                    <CardBody>
                        ...
                        <Button>Go somewhere, you</Button>
                    </CardBody>
            </Card>
        </div>
    )
