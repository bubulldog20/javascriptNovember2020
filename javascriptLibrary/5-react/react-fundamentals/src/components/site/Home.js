    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <p>This is intended to be a starter/tutorial app for you upcoming project and a learning sandbox for you in the months and years to come should you continue to develop software with React. In this application we will work through some of the basic React concepts, build out some small applications, and then unleash you to build your own applications.</p>
                <hr />
