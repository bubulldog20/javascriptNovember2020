...
class User {
    ...
    constructor(first, last, e) {
        //On the right side of these expressions, the word 'first', 'last', and 'e' below, we have the value that is getting passed into the parens when the object is created. vvvvv
        this.f = first;
        this.l = last;
        this.email = e;
