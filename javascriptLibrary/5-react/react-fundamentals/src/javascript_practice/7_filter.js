const instructors = [
    ...
    {name: 'Paul', specialty: 'Quantum Mechanics', medals: 2},
...
//If done correctly, in your terminal you should see after console logging instructorInfo -> {name:'Aaron', specialty: 'Entomology', medals:7}
